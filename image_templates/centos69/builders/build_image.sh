...
ISOURL="http://10.110.19.1/isos/CentOS-6.9-x86_64-minimal.iso"
OUTDIR=/tmp/centos69-$BUILD_TAG
IMGNAME=centos69x86_64-$BUILD_TAG.qcow2
...
cd $WORKSPACE
$PACKER_EXEC build -var "outdir=$OUTDIR" -var "vmname=$IMGNAME" -var "isourl=$ISOURL" centos69x86_64.json
